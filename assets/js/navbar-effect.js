...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (navLinks) {
      ...
      // Handle the theme toggle separately
      const themeToggle = macLinks.querySelector('#themeToggle');
      if (themeToggle) {
        themeToggle.style.transition = 'transform 0.2s ease, background-color 0.3s ease';
